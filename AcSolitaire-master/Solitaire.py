...
class HoverButton(tk.Button):
    def __init__(self, parent, movetype="Click", alt=None, ttjustify="left", ttbackground="#f1f1f1",#"#ffffe0",
...
class Stopwatch(tk.Label):
    def __init__(self, parent, **kwargs):
        tk.Label.__init__(self, parent, text="", **kwargs)
        self.value = 0
        self.job_id = None
...
class SolitareGameFrame(tk.Frame):
    ...
    def draw_up_cards(self, row, col):
        ...
        if self.movetype == "Accessability Mode":
            ...
            #Sam
            #self.canvas.tag_bind(card_tag, "<Double-Button-1>", self.card_ondbclick)
...
#(self.starting_points + (self.cards_on_ace * self.point_increment)) - 52
    ...
    #Sam: Automatically move to the foundation
    ...
    #Sam: double click on card
    def card_ondbclick(self, event):
        #self.send_cards_up
        #messagebox.showinfo(title="666", message="666")
        #if self.move_flag:
        #    return
    ...
    def continue_onclick(self, ace_slot, event):
        ...
        if secondreturnval:
            ...
            #deal with the card process --Sam
            flipped_cards = []
            moved_cards = {}
        ...
        if self.cards_on_ace == 52:
            ...
            after_game = messagebox.showinfo(
                "You've won!", "Congratulations! You've won the game!", icon="warning")
            if after_game == "ok":
                self.destroy()
                exit()
...
class Settings(tk.Toplevel):
    def __init__(self, parent, **kwargs):
        tk.Toplevel.__init__(self, parent, **kwargs)
        self.title("ACSolitaire Settings")
        self.resizable(False, False)
        self.config(background="#b0acac")
        ...
        self.gametype_chooser_options = [
            "Classic", "Vegas"]#, "Practice Mode", "Custom"
    ...
    def create_widgets(self):
        ...
        self.intro_label = tk.Label(self, text="ACSolitaire Settings", font=(
        ...
        self.python_card_button = tk.Radiobutton(self, text="AC card", variable=self.card_back_var,
   ...
   #                              padx=6, pady=5, sticky="ew")
    ...
    def reset_all(self):
        ...
        self.gametype_chooser_var.set("Classic")
